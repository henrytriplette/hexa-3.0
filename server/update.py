...
# get args
parser = ArgumentParser(description="Hexa 3.0 Updater, use '--update'.")
...
ignore_files = ["LICENSE", ".gitignore", "server/config.ini", "server/update.py",
                ".sources", ".github", ".github/workflows", ".github/workflows/update-version-file.yml"]
repository = {
    "name": "henrytriplette",
    "repo": "hexa-3.0",
    "branch": "main"
